...
/**
 * Servlet implementation class my_post
 */
@WebServlet("/my_post")
public class my_post extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			try {
				...
				String sql = "select * from arend_table where creatorID= ? order by createTime desc";
